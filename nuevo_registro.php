  ...
  <body>
    ...
    <div class="body-content container">
        ...
        <div class="row">
            ...
            <div class="col-md-9"> 
                <!--Nueva Insersion-->
                    <form action="agregarRegistro.php?target_user=<?php echo $_GET["target_user"];?>" method="post" 
                    name="formActualizarDatos">
                        <div class="row">
                            <div class="col-sm-offset-3 col-sm-4">
                                <p class="text-danger"><?php if(isset($_SESSION["error"])){echo $_SESSION["error"];
								unset($_SESSION["error"]);}?></p>
                                <p class="text-success"><?php if(isset($_SESSION["success"])){echo $_SESSION["success"];
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <a href="historial.php?target_user=<?php echo $_GET["target_user"];?>" target="_parent">Regresar</a>
                            </div>
                            <div class="col-sm-4">
                                <br />
