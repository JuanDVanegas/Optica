    ...
    <div class="body-content container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
				...
				$sql1 = "SELECT * FROM historial WHERE fk_paciente='".$_SESSION["id_usuario"]."' LIMIT $empieza,$cant_pagina";
				$query = "SELECT * FROM historial WHERE fk_paciente='".$_SESSION["id_usuario"]."'";
				...
				while($row1 = $result1->fetch_assoc())
				{
					...
					$sql2 = "SELECT * FROM usuario WHERE id_usuario = '$fk_medico'";
