        ...
        <div class="row">
            ...
            <div class="col-md-9"> 
                <!--Nueva Insersion-->
					...
					$sql2 = "SELECT * FROM historial WHERE fk_paciente='".$_SESSION["id_usuario"]."' AND fk_registro='$idRegistro'";
					...
					$sql3 = "SELECT * FROM usuario WHERE id_usuario='$fk_medico'";
